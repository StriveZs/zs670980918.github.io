---
title: Hexo中Next主题添加主页标签页以及美化标签页
categories:
  - 文章页
  - Hexo
  - Next主题
...
```
代码添加到内容最后面即可如下：
![figure1](https://gitee.com/zyp521/upload_image/raw/master/F9Uxht.png)
...
### 显示效果
![figure5](https://gitee.com/zyp521/upload_image/raw/master/YEbyBB.png)
## 美化标签页面
### 添加球形标签页面
...
```
2. 在/themes/next/source/js/src/目录下，新建其依赖的bubble.js，内容如下:
```
/*
* 3d标签云
* 功能：鼠标移入标签，当前标签静止放大
...
```
3. 在/themes/next/layout/_layout.swig中，引入上边的bubble.js，引入位置在head标签内，比如这样:
![figure2](https://gitee.com/zyp521/upload_image/raw/master/42Ku3z.png)
4. 在/themes/next/layout/page.swig中，引入tag-bubble.swig,具体如下：
![figure3](https://gitee.com/zyp521/upload_image/raw/master/wuAtL9.png)
### 显示效果
具体显示效果如下：
![figure4](https://gitee.com/zyp521/upload_image/raw/master/NBI7PD.png)